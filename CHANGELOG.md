...
## [8.1.6] https://github.com/rfrey-imb/theo

- Exporting `resolve`, `load`, and `loadAndParse` function to allow a modified theo-loader (https://github.com/rfrey-imb/theo-loader) to leverage that code (for better or worse).
